            ...
            <blockquote class="blockquote mb-0">
              ...
              <footer class="blockquote-footer">
                <figcaption class="text-center">Photo by <a
                  href="https://unsplash.com/@picsbyjameslee?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" alt="" >James
                        Lee</a> on <a href="/t/textures-patterns?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" alt="" >Unsplash</a>
                </figcaption>
              </footer>
            </blockquote>
          </div>
            ...
            <div class="card-body">
              ...
              <footer class="blockquote-footer">
                ...
                <a href="https://unsplash.com/@eberhardgross?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Photo by 
                  <a href="https://unsplash.com/@cfitz?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Cody
                            Fitzgerald</a> on <a href="/t/nature?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                            </a>
                </figcaption>
              </footer>
            </div>
      ...
      <div className="col">
        <div class="card-fifth">
          <div class="card-body">
            ...
            <footer class="blockquote-footer">
              <figcaption class="text-center">Photo by 
              <a href="https://unsplash.com/@jeisblack?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Jason Blackeye</a> on <a
